    ...
    <div v-loading="loading" class="bg-white p-4 rounded">
        <el-form :model="form" label-width="160px">
            ...
            <el-form-item label="一级返佣比例">
                ...
                <small class="text-gray-500 flex mt-1">订单交易成功后给上级返佣比例0-100，例：5 = 返订单金额的5%</small>
            </el-form-item>
            ...
            <el-form-item label="自购返佣">
                <div>
                    ...
                    <small class="text-gray-500 flex mt-1">是否开启自购返佣（开启：分销员自己购买商品，享受一级返佣，上级享受二级返佣：关闭：分销员自己购买商品没有返佣）
                    </small>
                </div>
            </el-form-item>
            <h5 class="bg-gray-100 p-3 rounded mb-5">结算设置</h5>
            <el-form-item label="结算时间">
                <el-input v-model="form.settlement_days" placeholder="一级返佣比例" style="width: 50%;" type="number">
                    <template #prepend>订单完成后</template>
                    <template #append>天</template>
                </el-input>
                <small class="text-gray-500 flex mt-1">预估佣金结算后无法进行回收，请慎重设置结算天数</small>
            </el-form-item>
            <el-form-item label="佣金到账时间">
                <div>
                    <el-radio-group v-model="form.brokerage_method">
                        <el-radio label="band" border>
                            手动到账
                        </el-radio>
                    ...
                    <small class="text-gray-500 flex mt-1">佣金到账方式支持线下转账和零钱自动转账，手动转账更安全，自动转账更方便
                    </small>
                </div>
            </el-form-item>
